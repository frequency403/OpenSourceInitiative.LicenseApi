...
public interface IOsiLicensesClient : IDisposable, IAsyncDisposable
{
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<IReadOnlyList<OsiLicense>> GetLicensesByKeywordAsync(string keyword, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<IReadOnlyList<OsiLicense>> GetLicensesByKeywordAsync(OsiLicenseKeyword keyword, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<IReadOnlyList<OsiLicense>> GetLicensesByStewardAsync(string steward, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    Task<IReadOnlyList<OsiLicense>> GetLicensesBySpdxPatternAsync(string spdxPattern, CancellationToken cancellationToken = default);
    ...
    /// <summary>
    /// Synchronous wrapper for <see cref="GetLicensesByKeywordAsync"/>.
    /// </summary>
    IReadOnlyList<OsiLicense> GetLicensesByKeyword(string keyword);

    /// <summary>
    /// Synchronous wrapper for <see cref="GetLicensesByKeywordAsync(OsiLicenseKeyword,System.Threading.CancellationToken)"/>.
    /// </summary>
