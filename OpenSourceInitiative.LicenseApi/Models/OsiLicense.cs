...
public sealed record OsiLicense
{
    ...
    /// </summary>
    [JsonPropertyName("board_minutes")]
    public string? BoardMinutes { get; init; }

    /// <summary>
    ///     List of stewards involved, if any.
    /// </summary>
    [JsonPropertyName("stewards")]
    public IReadOnlyCollection<string> Stewards { get; init; } = [];
    ...
    public IReadOnlyCollection<OsiLicenseKeyword> Keywords { get; init; } = [];

    /// <summary>
    ///     Links to the API self page, public HTML page and collection.
    /// </summary>
    [JsonPropertyName("_links")]
    public OsiLicenseLinks Links { get; init; } = new();
